...
${OBJECTDIR}/src/Engine.o: src/Engine.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SFML-2.5.1/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Engine.o src/Engine.cpp

${OBJECTDIR}/src/Object.o: src/Object.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SFML-2.5.1/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Object.o src/Object.cpp

${OBJECTDIR}/src/draw.o: src/draw.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SFML-2.5.1/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/draw.o src/draw.cpp

${OBJECTDIR}/src/input.o: src/input.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SFML-2.5.1/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/input.o src/input.cpp

${OBJECTDIR}/src/main.o: src/main.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SFML-2.5.1/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp

${OBJECTDIR}/src/update.o: src/update.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SFML-2.5.1/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/update.o src/update.cpp
